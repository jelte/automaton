...
use Automaton\Stage\StagePlugin;
...
class StagePluginTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Automaton\Stage\Stage', $this->plugin->stage('test', array('server-1')));
        $this->assertInstanceOf('Automaton\Stage\Stage', $this->plugin->stage('test', array('server-1'), array('branch' => 'develop')));
        $this->assertInstanceOf('Automaton\Stage\Stage', $this->plugin->stage('test', array('server-1'), array('branch' => 'develop'), true));
